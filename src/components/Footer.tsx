  ...
  return (
    <footer className="w-full pt-12 md:pt-16 pb-10 md:pb-14">
      <div className="max-w-[1600px] mx-auto px-10 md:px-14">
        {/* Divider */}
        <div className="border-t border-foreground/10 mb-8 md:mb-10" />
        ...
        <div className="md:hidden space-y-4">
          ...
          <a
            ...
            className="block text-[14px] font-light text-foreground/70 hover:text-foreground transition-colors"
          >
        ...
        <div className="hidden md:flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            <a
              href="mailto:oliver.bolt@gmail.com"
              className="text-[14px] font-light text-foreground/70 hover:text-foreground transition-colors"
            >
              oliver.bolt@gmail.com
            </a>
